package saz.display.dialog {
	...
	public class SimpleQuestionDialog extends DialogBase {
		...
		public var yesButton:CastButton;
		public var noButton:CastButton;
		
		/**
		 * 新しい SimpleQuestionDialog インスタンスを作成します。
		 */
		public function SimpleQuestionDialog( initObject:Object = null ) {
			// 親クラスを初期化します。
			super( initObject );
			...
			alpha = 0;
			// ボタンを初期化。
			$initButton(yesButton, DialogResult.YES);
			$initButton(noButton, DialogResult.NO);
		}
