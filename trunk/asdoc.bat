...
REM 64bit
"C:\ols\flex_sdk_3.5\bin\asdoc.exe" -main-title "sazLib_as3" -title "sazLib_as3" -window-title "sazLib_as3" -output "E:\_saz\LIB\as3\doc" -doc-sources "E:\_saz\LIB\as3\work\src\saz" -source-path "E:\_saz\LIB\as3\work\src" -library-path "C:\Program Files (x86)\Adobe\Adobe Flash CS5.5\Common\Configuration\ActionScript 3.0\FP10" -library-path "E:\_saz\LIB\as3\work\swc" -compiler.strict=false -compiler.show-actionscript-warnings=false
