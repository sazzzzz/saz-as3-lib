package saz.collections {
	 ...
	 */
	//dynamic public class IndexedListProxy implements IList extends Proxy {		// Proxyにimplements使えないみたい。==>ええええ？！意味ないじゃん
	dynamic public class IndexedListProxy extends Proxy {
		 ...
		 * @param	list
		 */
		public function IndexedListProxy(list:List = null) {
		...
		override flash_proxy function callProperty(methodName:*, ... args):*{
			...
			switch(methodName.toString()) {
				case 'clone':
					res = new IndexedListProxy($list.clone());
					break;
