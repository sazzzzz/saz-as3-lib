package saz.util.twitter {
	...
	public class TwitterUtil {
		//public static const REG_URL:String = "(\\s|^)((https?|ftp)://[0-9a-zA-Z,;:~&=@_'%?+\-/$.!*()]+)(\\s|$)";
		//public static const REG_URL:String = "(\\s|^)" + RegExpUtil.REG_URL + "(\\s|$)";
		//public static const REPL_URL:String = "$1<a href=\"$2\">$2</a>$4";
		 ...
		 * ハッシュタグに一致する正規表現。
		 */
		public static const REG_HASHTAG:String = "\#(\\w+)";
		
		/**
		 * ハッシュタグリンク生成用置換文字列。
		 */
		//public static const REPL_HASHTAG:String = '<a href="http://search.twitter.com/search?q=%23$1" target="_blank">#$1</a>';
		public static const REPL_HASHTAG:String = '<a href="' + $URL_HASHTAG1 + '%23$1" target="_blank">#$1</a>';
		
		/**
		 * ＠ユーザー名に一致する正規表現。
		 */
		public static const REG_REPLY:String = "\@(\\w+)";
		
		/**
		 * ＠ユーザー名リンク生成用置換文字列。
		 */
		//public static const REPL_REPLY:String = '@<a href="http://twitter.com/$1" target="_blank">$1</a>';
		public static const REPL_REPLY:String = '@<a href="' + $URL_REPLY1 + '$1" target="_blank">$1</a>';
		 ...
		 * @return
		 */
		public static function genTweetLinks(text:String):String {
			// URL変換を一番最初に実行
		 ...
		 * @return
		 */
		public static function genHashTagLink(text:String):String {
			return text.replace(
		 ...
		 * @return
		 */
		public static function genReplyLink(text:String):String {
			return text.replace(
